          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <span className="text-2xl font-bold font-heading text-slate-900">80</span>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                <span className="text-slate-500 block mb-1">Available Lots</span>
                <span className="text-2xl font-bold font-heading text-emerald-700">55</span>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                <span className="text-slate-500 block mb-1">Occupied / Reserved</span>
                <span className="text-2xl font-bold font-heading text-amber-700">25</span>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <span className="text-2xl font-bold font-heading text-emerald-700">₱25,000</span>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                <span className="text-slate-500 block mb-1">Total Outstanding Balances</span>
                <span className="text-2xl font-bold font-heading text-amber-700">₱25,000</span>
              </div>
            </div>
          </div>
        )}
        ...
        {reportType === 'burials' && (
          <div className="space-y-4 text-xs">
            ...
            <p className="text-slate-700">
              Total burial services conducted in reporting period: <span className="font-bold text-slate-900">2</span>. All recorded in Section A and Section B.
            </p>
          </div>
        )}
      </div>
