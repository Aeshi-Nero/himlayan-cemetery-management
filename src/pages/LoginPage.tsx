...
export const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Failed to authenticate. Verify credentials.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full lg:w-[55%] h-full overflow-y-auto bg-slate-50 relative">
        <div className="min-h-full flex items-center justify-center p-6 sm:p-12 lg:p-24 relative z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="#" className="text-xs text-emerald-600 hover:text-emerald-700 font-semibold hover:underline">Forgot?</a>
              </div>
              <div className="relative group">
          ...
          <div className="text-center pt-8 lg:hidden">
            <Link to="/" className="text-xs text-slate-500 hover:text-emerald-700 transition-colors inline-flex items-center gap-1 font-medium">
