...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const pageUser = props.auth.user as AuthUser | null;
  const [user, setUser] = useState<AuthUser | null>(pageUser);
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between relative">
        ...
        {(!isAuthenticated || user?.role !== 'engineer') && currentPath !== '/engineer/workspace' && (
