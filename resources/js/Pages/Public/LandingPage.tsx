...
const GALLERY_ITEMS: GalleryItem[] = [
    {
        ...
        description:
            'Serene, manicured flat lawn plots with flush bronze markers surrounded by mature cypress trees and gentle morning sunlight.',
    ...
    },
    {
        ...
        image: mausoleumImg,
        description:
            'Private family mausoleum structures with elegant marble craftsmanship, landscaped entryways, and granite pillars.',
    ...
    },
    {
        ...
        image: pathwayImg,
        description:
            'Shaded stone promenades with marble resting benches, offering direct turn-by-turn walking access from primary gates.',
    ...
    },
    {
        ...
        image: terracesImg,
        description:
            'Elevated columbarium garden wall niches featuring brass memorial plaques and fresh flower arrangements.',
    ...
    },
    {
        ...
        image: chapelImg,
        description:
            'Quiet interfaith chapel and administrative sanctuary nestled among historic oak trees for family reflection.',
    ...
    },
    {
        ...
        description:
            'Lush memorial garden with seasonal flowers, marble benches, and a peaceful water feature for meditation.',
        ...
        const fetchPlotsAndBurials = async () => {
            try {
                const [plotsRes, burialsRes] = await Promise.all([
                    window.axios.get('/api/plots', { params: { limit: 1000 } }),
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 font-body selection:bg-emerald-700 selection:text-white">
            ...
            <section className="relative min-h-[90vh] sm:min-h-[100vh] w-full overflow-hidden bg-emerald-950 flex flex-col items-center justify-start pt-56 sm:pt-64 md:pt-76 pb-16">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 text-center flex flex-col items-center justify-center mt-2 sm:mt-4 md:mt-6">
                    ...
                    >
                        Browse available memorial lots, explore interactive turn-by-turn pathfinding
                        directions, submit burial inquiries, and access administrative records with
                        dignity.
                    </motion.p>
                            ...
                            <div className="absolute left-0 right-0 top-full mt-2 bg-white border border-slate-200/90 rounded-2xl shadow-2xl z-50 overflow-y-auto max-h-64 divide-y divide-slate-100 text-left animate-fadeIn">
                                {searchSuggestions.length > 0 ? (
                                    ...
                                    <div className="p-4 text-center text-xs text-slate-500 italic">
                                        No matching records found for "{searchQuery}". Try "Maria", "Santos", or
                                        "Section A".
                                    </div>
                                )}
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-14">
                        ...
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                            Himlayan Memorial Park combines sacred tradition with modern digital
                            mapping, contract workflows, and public transparency.
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                            Hover over any picture to reveal section details, architecture
                            descriptions, and pricing specifications. Click to inspect
                            high-resolution grounds views.
                        </p>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-2 mt-8">
                            {[
                                ...
                                {
                                    label: 'Columbarium & Terraces',
                                    value: 'Columbarium & Terraces',
                                },
            ...
            <section className="py-20 bg-slate-50 text-slate-900 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-14">
                        ...
                        />
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                            Designed to satisfy the highest administrative standards while offering
                            seamless access to the general public.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-slate-50 text-slate-900 border-t border-slate-200 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-14">
                        ...
                        />
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                            We provide essential facilities to ensure that every visit is
                            comfortable, peaceful, and secure for all families and guests.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white text-slate-900 border-t border-slate-200 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-14">
                        ...
                        />
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                            We take pride in providing a dignified and serene resting place for your
                            loved ones, supported by compassionate service.
                        </p>
                    </div>
            ...
            <section className="relative py-24 bg-emerald-950 text-white text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-emerald-100 text-sm sm:text-base max-w-2xl mx-auto mb-10 font-normal">
                        Providing peace of mind through organized digital records, respectful
                        cemetery maintenance, and open public mapping.
                    </p>
                    ...
                    <div className="bg-slate-900 rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="text-emerald-100/80 text-sm sm:text-base max-w-2xl mx-auto mb-8 font-normal">
                                Join our newsletter for park updates, community events, or submit
                                your email to request an official pricing brochure.
                            </p>
                            ...
                            <form
                                onSubmit={(e) => {
                                    e.preventDefault();
                                    alert(
                                        'Thank you for subscribing! We will send updates to your email.',
                                    );
                                }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 text-white">
                                ...
                                <span className="font-heading italic font-bold text-xl tracking-wide">
                                    Himlayan
                                </span>
                            </div>
                            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
                                A serene resting place providing comprehensive memorial services,
                                meticulous groundskeeping, and dignified care for your loved ones.
                            </p>
                            <div className="flex gap-4">
                                <a
                                    href="#"
                                    className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-emerald-500 hover:text-white transition-colors text-slate-400"
                                >
                        ...
                        {/* Quick Links */}
                        <div>
                            <h3 className="text-white font-heading font-bold mb-6 tracking-wide uppercase text-sm">
                                Quick Links
                            </h3>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3 text-sm text-slate-400">
                                    ...
                                    <span>
                                        123 Memorial Drive, Serenity Park, Quezon City, Philippines
                                    </span>
                                </li>
